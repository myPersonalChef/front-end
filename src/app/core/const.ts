...
export const plans = [
    {
        id: 1,
        name: "3 Meals",
        description:"1 week trial, Get three meals, Meals are served on weekdays.",
        per_meal_info: "$4.99/meal",
        price:"$14.99"
      },
      {
        id: 2,
        name: "12 Meals",
        description:"1 Month plan, Get 12 meals, Meals are served on weekdays.",
        per_meal_info: "$xx.xx/meal",
        price:"$XX.XX"
      }
];
...
export const recipes = [
  {
		...
		"recipe_id": "47746",
		"image_url": "https://firebasestorage.googleapis.com/v0/b/mypersonalchef-93bd2.appspot.com/o/recipe_images%2F54491.jpg?alt=media&token=06af6376-f01d-4f7e-b9e7-9e9d7a810c4c",
		"social_rank": 100.0,
